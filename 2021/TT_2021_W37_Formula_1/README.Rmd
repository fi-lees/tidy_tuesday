...
```{r Visualise_mercedes_2021, fig.asp = 0.75, fig.alt = "Connected dot plot (also known as a dumbbell plot), showing the finishing positions of Formula 1 Mercedes drivers Lewis Hamilton and Valtteri Bottas in each race this season. Hamilton has won five out fifteen races in the 2021 season so far. Bottas hasn't won any races yet, but has finished ahead of Hamilton in three races."}
